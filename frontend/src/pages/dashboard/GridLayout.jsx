...
const ItemCortes = React.lazy(() => import('../currentline/dashboard/ItemCortes'));
const ItemActions = React.lazy(() => import('../currentline/dashboard/ItemActions'));
const ItemAgg = React.lazy(() => import('../currentline/dashboard/ItemAgg'));
const ItemNav = React.lazy(() => import('../currentline/dashboard/ItemNav'));
const ItemReciclado = React.lazy(() => import('../currentline/dashboard/ItemReciclado'));
const ItemBobinagens = React.lazy(() => import('../currentline/dashboard/ItemBobinagens'));
//const ItemFormulacao = React.lazy(() => import('../currentline/dashboard/ItemFormulacao'));
...
const ItemNonwovens = React.lazy(() => import('../currentline/dashboard/ItemNonwovens'));
const ItemGamaOperatoria = React.lazy(() => import('../currentline/dashboard/ItemGamaOperatoria'));
const ItemSpecs = React.lazy(() => import('../currentline/dashboard/ItemSpecs'));
const ItemOrdensFabrico = React.lazy(() => import('../currentline/dashboard/ItemOrdensFabrico'));
const ItemOperations = React.lazy(() => import('../currentline/dashboard/ItemOperations'));
const ItemPickingNW = React.lazy(() => import('../currentline/dashboard/ItemPickingNW'));
const ItemGranuladoList = React.lazy(() => import('../currentline/dashboard/ItemGranuladoList'));
const ItemStockAvailable = React.lazy(() => import('../currentline/dashboard/ItemStockAvailable'));
const ItemLineLogList = React.lazy(() => import('../currentline/dashboard/ItemLineLogList'));
const ItemEventosProducao = React.lazy(() => import('../currentline/dashboard/ItemEventosProducao'));
const ItemGranuladoInLine = React.lazy(() => import('../currentline/dashboard/ItemGranuladoInLine'));
const ItemMPLocal = React.lazy(() => import('../currentline/dashboard/ItemMPLocal'));
const ItemReportReciclado = React.lazy(() => import('../currentline/dashboard/reports/ItemReportReciclado'));
const ItemEstadoProducao01 = React.lazy(() => import('../currentline/dashboard/ItemEstadoProducao01'));
...
const Pin = styled(Button).withConfig({ shouldForwardProp: (prop) => ![].includes(prop) })`
...
export default (props) => {
    ...
    useEffect(() => {
        ...
        updateHash(draft => {
            if (wsMessageBroadcast?.hash?.hash_estadoproducao !== hash?.hash_estadoproducao) {
                draft.hash_estadoproducao = wsMessageBroadcast?.hash?.hash_estadoproducao;
            }
            if (wsMessageBroadcast?.hash?.hash_estadoproducao_realtime !== hash?.hash_estadoproducao_realtime) {
    ...
    }, [media?.breakpoint, hash.updated, location]);
