                    ...
                    <Row nogutter style={{ background: "#f6f8fa", borderBottom: "solid 1px #d0d7de", height: "40px", alignItems: "center", padding: "0px 15px" }}>
                        <Col>
                            {(modeEdit.form || modeEdit.datagrid) ? <Row nogutter justify='end'>
                                <Col xs="content">
                                    <Button onClick={() => onFinish("save")}>{(dataAPI.getData().valid === 1) ? 'Classificar Bobinagem' : 'Validar Bobinagem'}</Button>
                            ...
                            <Row nogutter>
                                <Col style={{ padding: "10px" }}>
                                    ...
                                    <Row gutterWidth={5} style={{ marginBottom: "10px" }}>
                                        ...
                                        <Col width={150}><Field name="comp_par" forInput={modeEdit.form && dataAPI.getData().new_nw_lotes === 1} required label={{ enabled: true, text: "Comprimento Emenda", padding: "0px" }}><InputNumber style={{ textAlign: "right" }} min={0} addonAfter={<b>m</b>} /></Field></Col>
