...
export default (props) => {
    ...
    const columns = [
        { key: 'root', sortable: false, name: 'Raíz', width: 130, frozen: true, formatter: p => <Button style={{ color: "#0050b3", fontWeight: 700 }} size="small" type="link" onClick={() => onBobineClick(p.row)}>{p.row.root}</Button> },
        { key: 'bobine0', sortable: false, name: 'Bobine', width: 130, frozen: true, formatter: p => <Button style={{ color: "#0050b3", fontWeight: 700 }} size="small" type="link" onClick={() => onBobineClick(p.row)}>{p.row.bobine0}</Button> },
