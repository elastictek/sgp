...
export default ({ extraRef, closeSelf, loadParentData, ...props }) => {
    ...
    const [subTitle, setSubTitle] = useState("Cortes");
                                    ...
                                    <Row>
                                        ...
                                        {state.step == 1 && <Col>
                                            <YScroll maxHeight={"80vh"}>
                                                <FormCortes noHeader={true} setFormTitle={true} parameters={{ ofabrico_status:state.pos.items[0].ofabrico_status, agg_of_id: state.pos.items[0].agg_id, cs_id: state.pos.items[0].cs_id, type: "cortes" }} />
                                            </YScroll>
                                        </Col>}
                                    </Row>
                                </Container>
