...
import FormNonwovens from '../ordensfabrico/FormNonwovens';
                            ...
                            <Col>
                                <Container fluid style={{ borderRadius: "3px", border: "1px dashed #d9d9d9", marginTop: "10px", padding: "5px" }}>
                                    <Row>
                                        ...
                                        {state.step == 1 && <Col>
                                                <FormNonwovens loadParentData={()=>prev(0)} setFormTitle={true} parameters={{ cs_id: state.pos.items[0].cs_id, type: "nonwovens" }} />
                                        </Col>}
                                    </Row>
                                </Container>
                            </Col>
