...
import {schemaGamaOperatoria as schema} from './FormOrdemFabrico';
...
export default ({ parameters, extraRef, closeSelf, loadParentData, form, ...props }) => {
    ...
    return (
        <YScroll>
            <SubContainer fluid schema={schema} forInput={permission.isOk({ item: "planeamento", action: "gamaoperatoria" })} loading={submitting.state}>
