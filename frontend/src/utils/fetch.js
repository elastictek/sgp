...
const fetch = async ({ url = "", norun = false, apiversion = "", responseType = "json", method = "get", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {}, cancelToken, signal, dates = [], withCredentials } = {}, f = true) => {
  return await serverRequest({ url, norun, apiversion, responseType, method, filter, sort, pagination, timeout, parameters, cancelToken, signal, dates, withCredentials }, f);
...
export const fetchPostStream = async ({ url = "", norun = false, apiversion = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {}, cancelToken, dates = [], withCredentials } = {}) => {
  return await fetch({ url, responseType: "stream", method: "post", filter, sort, pagination, timeout, parameters, cancelToken, dates, withCredentials, norun, apiversion });
}

export const fetchPostBuffer = async ({ url = "", norun = false, apiversion = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {}, cancelToken, dates, withCredentials } = {}) => {
  return await fetch({ url, responseType: "arraybuffer", method: "post", filter, sort, pagination, timeout, parameters, cancelToken, dates, withCredentials, norun, apiversion });
}
