...
def retrabalho_confirmacao(request, pk, b1, m1, b2=None, m2=None, b3=None, m3=None):
    ...
    if form.is_valid():
        ...
        if recycle_2 == True and b_2 != "N/A":
            ...
            reciclado_status = addToReciclado({"qtd":a_2,"source":"bobinagem_retrabalho","timestamp":datetime.now(),"lote":b_2.nome,"unit":"m2","user_id":request.user.id},None )
            if reciclado_status == False:
                pass
            try:
                movimento_bobine = MovimentosBobines.objects.create(
        ...
        if recycle_3 == True and b_3 != "N/A":
            ...
            reciclado_status = addToReciclado({"qtd":a_3,"source":"bobinagem_retrabalho","timestamp":datetime.now(),"lote":b_3.nome,"unit":"m2","user_id":request.user.id},None )
            if reciclado_status == False:
                pass
            try:
                movimento_bobine = MovimentosBobines.objects.create(
