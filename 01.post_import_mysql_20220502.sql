...
--
-- Host: 192.168.0.16    Database: sistema_dev
-- ------------------------------------------------------
...
CREATE TABLE `audit_producao_bobine` (
  ...
  `nome` varchar(200) COLLATE latin1_bin DEFAULT NULL,
  `posicao_palete` int unsigned NOT NULL,
  `estado` varchar(4) COLLATE latin1_bin NOT NULL,
  ...
  `prop_obs` longtext COLLATE latin1_bin,
  `sbrt` tinyint(1) NOT NULL,
  `suj` tinyint(1) NOT NULL,
  `comp` decimal(10,2) DEFAULT NULL,
  `designacao_prod` varchar(100) COLLATE latin1_bin DEFAULT NULL,
  `diam` decimal(10,2) DEFAULT NULL,
  `cliente` varchar(100) COLLATE latin1_bin DEFAULT NULL,
  `desp` decimal(10,2) DEFAULT NULL,
  `tipo_desp` varchar(4) COLLATE latin1_bin DEFAULT NULL,
  `para_retrabalho` tinyint(1) NOT NULL,
  `type_op` varchar(45) COLLATE latin1_bin DEFAULT NULL,
  `timestamp` datetime(6) DEFAULT NULL,
  `action` varchar(8) COLLATE latin1_bin DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `current_nw_lotes` (
  ...
  `matprima_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
  `lote_i_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
  `lote_f_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2333 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ig_consumo_nw` (
  ...
  `t_stamp` datetime DEFAULT CURRENT_TIMESTAMP,
  `matprima_sup_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
  `matprima_inf_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
  `lote_sup_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
  `lote_inf_cod` varchar(25) COLLATE latin1_bin DEFAULT NULL,
  `current_settings_id` int DEFAULT NULL,
  `type` int DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=34415 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `lotesdosers` (
  ...
  `lote_id` int DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7940 DEFAULT CHARSET=latin1 COLLATE=latin1_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'sistema_dev'
--

--
-- Dumping routines for database 'sistema_dev'
--
...
INSERT INTO producao_bobinagem(`timestamp`,nome,`data`,num_bobinagem,comp,tiponwinf,tiponwsup,estado,nwinf,nwsup,comp_cli,diam,area,perfil_id,user_id,inico,fim,duracao,desper,area_g,area_dm,area_r,area_ind,area_ba,comp_par, audit_current_settings_id,num_emendas,valid)
select 
CURRENT_TIMESTAMP,
...
-- Dump completed on 2022-05-03  8:55:52
