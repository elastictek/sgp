...
const serverRequest = async (request, fetch = true) => {
  const { url = "", responseType = "json", method = "get", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = request;
...
const fetch = async ({ url = "", responseType = "json", method = "get", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = {}) => {
  return await serverRequest({ url, responseType, method, filter, sort, pagination, timeout, parameters });
...
export const fetchPostTest = async ({ url = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = {}) => {
  ...
  export const fetchPost = async ({ url = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = {}) => {
    return await fetch({ url, method: "post", filter, sort, pagination, timeout, parameters });
  }

  export const fetchPostBlob = async ({ url = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = {}) => {
    return await fetch({ url, responseType: "blob", method: "post", filter, sort, pagination, timeout, parameters });
  }

  export const fetchPostStream = async ({ url = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = {}) => {
    return await fetch({ url, responseType: "stream", method: "post", filter, sort, pagination, timeout, parameters });
  }

  export const fetchPostBuffer = async ({ url = "", filter = {}, sort = [], pagination = {}, timeout = 10000, parameters = {} } = {}) => {
    return await fetch({ url, responseType: "arraybuffer", method: "post", filter, sort, pagination, timeout, parameters });
  }

  export const serverPost = async ({ url = "", timeout = 10000, parameters = {} } = {}) => {
    return await serverRequest({ url, method: "post", timeout, parameters }, false);
  };
